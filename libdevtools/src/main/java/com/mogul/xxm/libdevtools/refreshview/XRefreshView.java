package com.mogul.xxm.libdevtools.refreshview;
...
//        if(mHolder.mOffsetY!=0)return;
        LogRUtils.d("onLayout mHolder.mOffsetY=" + mHolder.mOffsetY);
        int childCount = getChildCount();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                LogRUtils.d("isTop=" + mContentView.isTop() + ";isBottom=" + mContentView.isBottom());
    ...
    private void resetHeaderHeight() {
        ...
        LogRUtils.d("resetHeaderHeight offsetY=" + offsetY);
    }
...
//            headerMovePercent = headerMovePercent > 1 ? 1 : headerMovePercent;
    ...
    public void stopRefresh(boolean success) {
        LogRUtils.d("stopRefresh mPullRefreshing=" + mPullRefreshing);
    ...
    private ScrollRunner mRunnable = new ScrollRunner() {
        ...
        public void run() {
            if (mScroller.computeScrollOffset()) {
                ...
                LogRUtils.d("currentY=" + currentY + ";mHolder.mOffsetY=" + mHolder.mOffsetY);

...
public class CircleImageView extends ImageView {
    ...
    public void setNetImage(String url, int defaultResId){
        if(url.equals("")){
        ...
        tagInfo.setUrl(url);
        Drawable drawable = loader.loadDrawableByTag(tagInfo, new AsyncImageLoader.ImageCallBack() {
            @Override
            public void obtainImage(TagInfo info) {
                setImageDrawable(info.getDrawable());
                initializeBitmap();
            }
        });
        if (null == drawable){
